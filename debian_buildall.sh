...
git clean -fxd
sudo apt install -y taskset virt-what python-cffi build-essential cpufrequtils cpuset linux-headers-4.9.0-9-all util-linux msr-tools policykit-1 openjdk-8-jdk pypy-dev luajit
